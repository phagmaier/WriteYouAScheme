...
/* package Parsing-0.1.0.0 */
#ifndef VERSION_Parsing
#define VERSION_Parsing "0.1.0.0"
#endif /* VERSION_Parsing */
#ifndef MIN_VERSION_Parsing
#define MIN_VERSION_Parsing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Parsing */
...
#define CURRENT_COMPONENT_ID "Parsing-0.1.0.0-inplace-Parsing"
